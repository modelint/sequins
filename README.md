...
At last, you can generate well organized, highly readable, and asesthetically pleasing sequence diagrams from
...
- It's diffcult to analyze a scenario and find potential errors when you have to dig through lots of overlapping lines, or when it is difficult to find the actors, states, or interactions of interest. So you want your layout to make it as easy as possible to understand what's going on in your scenario.
...
without every affecting your models and even use multiple layouts to view the same model input.
